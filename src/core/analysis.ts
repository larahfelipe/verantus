/**
 * Pure analysis core: provider-agnostic financial models computed from already
 * normalized inputs. No I/O and no upstream-schema knowledge — when an input is
 * missing we return null/empty so the UI can render "—" instead of inventing a
 * value.
 *
 * Sections:
 *   1. Model parameters     — every numeric assumption, named and documented.
 *   2. Quantitative models  — evolution stats, DCF and reverse DCF.
 *   3. Qualitative synthesis — moat, capital allocation, risk, thesis, research.
 */
